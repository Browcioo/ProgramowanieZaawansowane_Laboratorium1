...
using ProgramowanieZaawansowane_Laboratorium1.Data1;
using ProgramowanieZaawansowane_Laboratorium1.Models;

namespace ProgramowanieZaawansowane_Laboratorium1.Controllers
{
    public class ShoppingsController : Controller
    {
        private readonly MvcShoppingContext _context;

        public ShoppingsController(MvcShoppingContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Title,ReleaseDate,Price")] Shopping shopping)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Title,ReleaseDate,Price")] Shopping shopping)
        {
            if (id != shopping.ID)
            {
                return NotFound();
